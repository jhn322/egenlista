...
export const AUTH_MESSAGES = {
  ...
  ERROR_EMAIL_EXISTS_OAUTH: 'Emailen är redan registrerad via en annan tjänst (t.ex. Google). Prova att logga in med den istället.',
  ...
  ERROR_EMAIL_NOT_VERIFIED: 'Din e-post har inte verifierats. Vänligen kontrollera din e-post för en verifieringslänk eller begär en ny.',

  // Framgångsmeddelanden
  SUCCESS_REGISTRATION: 'Registrering lyckades! Kontrollera din inkorg för ett verifieringsmail.',
  SUCCESS_LOGIN: 'Inloggning lyckades!',
  SUCCESS_VERIFICATION: 'Din e-post har verifierats! Du kan nu logga in.',

  // Informationsmeddelanden
  INFO_VERIFICATION_EMAIL_SENT: 'Ett verifieringsmail har skickats. Kontrollera din inkorg.',

  // Övriga
  INFO_REGISTRATION_REDIRECT: 'Registrering lyckades! Omdirigerar till inloggning...',
